...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'DUX 主题设置', 'haoui' ),
			'menu_title' => __( 'DUX 主题设置', 'haoui' ),
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					...
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php echo __( '重置全部设置', 'haoui' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
			<div class="opshui-sidebar"><div class="opshui-sidebar-widget"><a href="https://themebetter.com" target="_blank"><img src="https://themebetter.com/tm/V15aGG/opad"></a></div></div>
		</div>
